...
class OptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create option" do
    assert_difference("Option.count") do
      post options_url, params: { option: { girl_id: @option.girl_id, o_name: @option.o_name, o_picture: @option.o_picture, o_price: @option.o_price } }
    end
  ...
  test "should update option" do
    patch option_url(@option), params: { option: { girl_id: @option.girl_id, o_name: @option.o_name, o_picture: @option.o_picture, o_price: @option.o_price } }
