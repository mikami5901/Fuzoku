...
class SystemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create system" do
    assert_difference("System.count") do
      post systems_url, params: { system: { course-time: @system.course-time, price: @system.price } }
    end
  ...
  test "should update system" do
    patch system_url(@system), params: { system: { course-time: @system.course-time, price: @system.price } }
